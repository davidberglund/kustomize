...
var nameReferenceFieldSpecs FieldReferenceList
var namePattern *regexp.Regexp

func init() {
	err := yaml.Unmarshal([]byte(nameReferenceFieldSpecsData), &nameReferenceFieldSpecs)
	if err != nil {
		panic(err)
	}
	namePattern = regexp.MustCompile(generateNamePattern)
}
