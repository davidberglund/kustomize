...
import (
	...
	"sigs.k8s.io/kustomize/kyaml/cmd/config/internal/commands"
	"sigs.k8s.io/kustomize/kyaml/cmd/config/internal/generateddocs/api"
	"sigs.k8s.io/kustomize/kyaml/cmd/config/internal/generateddocs/tutorials"
