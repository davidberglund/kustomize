...
metadata:
  ...
  annotations:
    app: nginx3
    config.kubernetess.io/package: foo-package/3
    config.kubernetess.io/path: f3.yaml
spec:
  replicas: 1
---
kind: Deployment
metadata:
  ...
  annotations:
    app: nginx2
    config.kubernetess.io/package: foo-package
...
metadata:
  ...
  annotations:
    app: nginx
    config.kubernetess.io/package: bar-package
