...
metadata:
  annotations:
    ...
    config.kubernetess.io/path: a_test.yaml
`,
			`c: d # second
metadata:
  annotations:
...
metadata:
  annotations:
    config.kubernetess.io/index: 0
    config.kubernetess.io/package: .
    config.kubernetess.io/path: b_test.yaml
`,
		}
		for i := range nodes {
...
metadata:
  annotations:
    config.kubernetess.io/index: 0
    config.kubernetess.io/package: a/b
...
metadata:
  annotations:
    config.kubernetess.io/index: 0
    config.kubernetess.io/package: a/c
    config.kubernetess.io/path: a/c/c_test.yaml
`, val)
}
