...
type ByteReadWriter struct {
	...
	// OmitReaderAnnotations will configures Read to skip setting the config.kubernetess.io/index
...
// By default, Read will set the config.kubernetess.io/index annotation on each RNode as it
